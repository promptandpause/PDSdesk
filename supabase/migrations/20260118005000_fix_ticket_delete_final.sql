-- Fix ticket deletion - use correct column names for ticket_links
...
begin
  ...
  -- Delete from related tables with correct column names
  ...
  -- ticket_links uses from_ticket_id and to_ticket_id (not source/target)
  delete from public.ticket_links where from_ticket_id = any(ticket_ids) or to_ticket_id = any(ticket_ids);
