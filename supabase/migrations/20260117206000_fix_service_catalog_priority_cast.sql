-- Fix submit_service_catalog_request - cast priority to ticket_priority enum
...
begin
  ...
  -- Cast priority to enum type
  v_priority := coalesce(v_catalog_item.default_priority, 'medium')::public.ticket_priority;
