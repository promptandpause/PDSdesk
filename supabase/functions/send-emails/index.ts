...
<body>
  ...
  <div class="footer"><p>Service Desk Team<br>servicedesk@promptandpause.com</p></div>
</body>
</html>`,
...
serve(async (req) => {
  ...
  try {
    ...
    for (const email of pendingEmails || []) {
      try {
        // Render template
        const htmlBody = email.body_html || renderTemplate(email.template_name, email.template_data);
