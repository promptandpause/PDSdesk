...
export function SupportingFilesView() {
  const files = [
    ...
    {
      id: 2,
      name: "SLA_Agreement_Microsoft.docx",
      folder: "Contracts",
      size: "456 KB",
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-white">
      ...
      <div className="border-b border-gray-300 px-4 py-3 flex items-center gap-3">
        ...
        <button className="px-3 py-2 border border-gray-300 text-sm rounded hover:bg-gray-100 flex items-center gap-2">
          <Filter size={14} />
          Filters
        </button>
      </div>
          ...
          <tbody>
            {files.map((file) => (
              ...
              >
                ...
                <td className="px-4 py-3">
                  <button className="text-[#4a9eff] hover:underline flex items-center gap-1">
                    <Download size={14} />
                    Download
                  </button>
                </td>
